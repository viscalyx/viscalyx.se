  ...
  const caseStudies = [
    {
      ...
      industry: "E-commerce",
      challenge: "Manual deployment processes causing 4-hour downtimes during peak shopping seasons, leading to significant revenue loss and customer dissatisfaction.",
      solution: "Implemented a comprehensive CI/CD pipeline with automated testing, blue-green deployments, and automated rollback capabilities using Azure DevOps and Kubernetes.",
      results: [
      ...
      technologies: ["Azure DevOps", "PowerShell DSC", "Kubernetes", "Terraform", "Docker"],
      duration: "6 months",
      teamSize: "8 people",
    ...
    },
    {
      ...
      industry: "Healthcare",
      challenge: "Manual patient data processing taking 8 hours daily, with high risk of errors in critical patient information and compliance issues.",
      solution: "Built an automated data pipeline with real-time processing, HIPAA compliance controls, and automated data validation using Python and Apache Airflow.",
      results: [
    ...
    },
    {
      ...
      challenge: "Legacy infrastructure limiting scalability, high operational costs, and difficulty meeting regulatory compliance requirements.",
      solution: "Migrated to cloud-native architecture with automated compliance checks, infrastructure as code, and comprehensive monitoring solutions.",
      results: [
    ...
    },
    {
      ...
      challenge: "Disconnected IoT devices, manual data collection, and lack of real-time insights into production processes.",
      solution: "Developed a comprehensive IoT automation platform with real-time data collection, predictive analytics, and automated quality control.",
      results: [
      ...
      image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&h=500&fit=crop&crop=center",
    ...
    },
    {
      ...
      industry: "Education",
      challenge: "Platform couldn't handle traffic spikes during enrollment periods, causing system crashes and lost revenue.",
      solution: "Implemented auto-scaling infrastructure, load balancing, and performance optimization with comprehensive monitoring.",
      results: [
      ...
      technologies: ["React", "Node.js", "AWS Lambda", "CloudFront", "DynamoDB"],
      duration: "5 months",
      teamSize: "7 people",
    ...
    },
    {
      ...
      industry: "Retail",
      challenge: "Manual inventory tracking across 200+ stores, frequent stockouts, and overstock situations leading to lost sales.",
      solution: "Created an automated inventory management system with real-time tracking, predictive restocking, and supply chain optimization.",
      results: [
            ...
            {caseStudies.map((study, index) => (
              ...
              >
                    ...
                    <div className="absolute bottom-6 left-6 right-6">
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 text-center">
                          <Building className="w-4 h-4 text-primary-600 mx-auto mb-1" />
                          <div className="text-xs font-medium text-secondary-900">{study.industry}</div>
                        </div>
                        <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 text-center">
                          <Clock className="w-4 h-4 text-primary-600 mx-auto mb-1" />
                          <div className="text-xs font-medium text-secondary-900">{study.duration}</div>
                        </div>
                        <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 text-center">
                          <Users className="w-4 h-4 text-primary-600 mx-auto mb-1" />
                          <div className="text-xs font-medium text-secondary-900">{study.teamSize}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                  ...
                  {/* Technologies */}
                  <div className="mb-6">
                    <h3 className="text-sm font-semibold text-secondary-900 mb-2">Technologies</h3>
